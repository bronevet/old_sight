...
attr::attr(std::string key, const char* val) : key(key), val(val) { init<char*      >(key, (char*)val); }
attr::attr(std::string key, void*       val) : key(key), val(val) { init<void*      >(key, val); }
attr::attr(std::string key, int         val) : key(key), val(val) { init<long       >(key, val); }
attr::attr(std::string key, long        val) : key(key), val(val) { init<long       >(key, val); }
attr::attr(std::string key, float       val) : key(key), val(val) { init<double     >(key, val); }
