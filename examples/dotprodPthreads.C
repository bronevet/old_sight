...
void *dotprod(void *arg)
{
   ...
   */
   ...
   { scope s("Partial Sum");
   dbgprintf("Adding partial sum of %f to global sum of %f\n",
...
int main (int argc, char *argv[])
{
  ...
  SightInit(argc, argv, "Dot Product Pthreads", "dbg.dotprodPthreads.individual");
  ...
  dbgprintf ("Done. Threaded version: sum =  %f \n", dotstr.sum);
  free (a);
  free (b);
