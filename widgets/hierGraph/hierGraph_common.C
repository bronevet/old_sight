...
hierGraph::context::context(properties::iterator props, std::string prefix) {
...
void hierGraph::context::add(std::string key, const attrValue& val)
{ configuration[key] = val; }

// Add all the key/attrValue pairs from the given context to this one, overwriting keys as needed
void hierGraph::context::add(const context& that) {
...
map<string, string> hierGraph::context::getProperties(std::string prefix) const {
...
std::string hierGraph::context::str() const {
  ostringstream s;
  s << "[context :";
...
std::string hierGraph::encodeCtxtName(const std::string& hierGraphClass, const std::string& ctxtGrouping, 
                                   const std::string& ctxtSubGrouping, const std::string& attrName) {
  return txt()<<escapedStr(hierGraphClass,  ":", escapedStr::unescaped).escape()<<":"<<
...
void hierGraph::decodeCtxtName(const std::string& encoded, 
