...
class hierGraphApp: public block, public common::hierGraph
{
  ...
  // hoa edit
  // The txt file that will hold the representation of the hierGraph graph
  std::ofstream tFile;
  ...
  hierGraphApp(properties::iterator props);
  ~hierGraphApp();
  
  // Returns the unique instance of hierGraphApp currently active
