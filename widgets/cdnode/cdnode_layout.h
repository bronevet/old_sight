...
class CDNodeLayoutHandlerInstantiator  : layoutHandlerInstantiator{
  public:
  CDNodeLayoutHandlerInstantiator();
};
extern CDNodeLayoutHandlerInstantiator CDNodeLayoutHandlerInstance;
...
class CDNode: public scope
{
  ...
  CDNode(properties::iterator props);
  public:
...
class StageNodeLayoutHandlerInstantiator  : layoutHandlerInstantiator{
  public:
  StageNodeLayoutHandlerInstantiator();
};
extern StageNodeLayoutHandlerInstantiator StageNodeLayoutHandlerInstance;
...
class StageNode: public scope
{
  ...
  //    low: label_interactive, label_shown, summary_entry
  //    min: label_shown, summary_entry
  StageNode(properties::iterator props);
  public:
