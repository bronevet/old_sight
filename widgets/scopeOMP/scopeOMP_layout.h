...
#include "../scope/scope_layout.h"

namespace sight {
namespace layout {

class scopeOMPLayoutHandlerInstantiator  : layoutHandlerInstantiator{
  public:
  scopeOMPLayoutHandlerInstantiator();
};
extern scopeOMPLayoutHandlerInstantiator scopeOMPLayoutHandlerInstance;
...
class scopeOMP: public scope
{
  ...
  scopeOMP(properties::iterator props);
  public:
