...
function displayTrace(traceLabel, hostDivID, ctxtAttrs, traceAttrs, viz, showFresh, showLabels, refreshView) {
  ...
  else if(viz == 'cscp')
  {
      ...
      var hostDivID = hostDivID+"_CSCP";//+ctxtStr+"_"+traceStr;
      ...
      numb = numTraceAttrs;
      /*
      showCirSCP(data, attrNames,
                    minVals, maxVals,
                    numContextAttrs, numTraceAttrs,
                    hostDivID);
                    */
      
      //window.location = "widgets/cscp/index.html";
      
      //document.write('<a href="widgets/trace/cscp/index.html">cscp</a>');
      //window.location.href = "widgets/trace/web-export/index.html";
  ...
  else if(viz == 'pcp')
  {
      ...
      newwindow=window.open("widgets/trace/web-export/index.html?data="+data+"&attrNames="+attrNames+"&minVals="+minVals+"&maxVals="+maxVals+"&numContextAttrs="+numContextAttrs+"&numTraceAttrs="+numTraceAttrs+"&hostDivID="+hostDivID,"PCP",'height=300,width=1400');
