function showDecisionTree(treeData, hostDivID) {
    ...
    // size of the diagram
    var viewerWidth  = Math.floor(jQuery(document).width()*.9);
    var viewerHeight = Math.floor(jQuery(document).height()*.9);
    ...
    var baseSvg = d3.select("#"+hostDivID).append("svg")
