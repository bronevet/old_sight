...
all: dbgLogTester${EXT} dbgLogGraphTester${EXT} ${DBGLOG} widgets/shellinabox/bin/shellinaboxd${EXT} widgets/mongoose/mongoose${EXT} widgets/graphviz/bin/dot${EXT}
...
ifeq (${OS},Cygwin)
	rm -f widgets/graphviz-2.32.zip widgets/release
