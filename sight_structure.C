...
comparison::comparison(int ID,                                       properties* props) : sightObj(setProperties(txt()<<ID, NULL,     props)) {}
comparison::comparison(int ID,                const attrOp& onoffOp, properties* props) : sightObj(setProperties(txt()<<ID, &onoffOp, props)) {}
