...
my $cmd = "/g/g15/bronevet/code/dbglog/widgets/shellinabox-2.14/shellinaboxd --cgi -t -s \"/:$username:$gid:".getcwd.":ssh -o PreferredAuthentications=keyboard-interactive -o PubkeyAuthentication=no $username\@$hostname gdb -x ".getcwd."/gdbscript\"";
