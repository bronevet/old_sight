...
#pragma omp single
    ...
    if( RR_threshold <= 0.0 )
    {
        dbg << "in IMC_4Momentum ctor:" << endl;
        dbg << "RR_threshold = " << RR_threshold << endl;
        dbg << "It has to be > 0.0!" << endl;
    }
...
traceAttr("IMC Energy", "E_photons_total", attrValue((double)Source_DB.get_E_photons_total()));
traceAttr("IMC Energy", "E_census_initial", attrValue((double)E_census_initial));
traceAttr("IMC Energy", "E_out", attrValue((double)E_out));
traceAttr("IMC Energy", "E_census_RR_created", attrValue((double)E_census_RR_created));
traceAttr("IMC Energy", "E_census_RR_destroyed", attrValue((double)E_census_RR_destroyed));
traceAttr("IMC Energy", "Net_RR_census_enerty", attrValue((double)(E_census_RR_created - E_census_RR_destroyed)));
traceAttr("IMC Energy", "E_small_photon_RR_created", attrValue((double)E_small_photon_RR_created));
traceAttr("IMC Energy", "E_small_photon_RR_destroyed", attrValue((double)E_small_photon_RR_destroyed));
traceAttr("IMC Energy", "net_RR_small_photon_energy", attrValue((double)(E_small_photon_RR_created - E_small_photon_RR_destroyed)));
traceAttr("IMC Energy", "E_RR_total", attrValue((double)E_RR_total));
