                   ...
                   context& solverCtxt, int& num_precond_calls)
{
          ...
          && cycle_count < max_iter)
   {
     sightModule modCycle(instance("V Cycle", 4, 1), 
      ...
      modCycle.setOutCtxt(0, context("resid_nrm", resid_nrm,
                                     "conv_factor", conv_factor,
                                     "relative_resid", relative_resid));
   }
   ...
   modSolve.setOutCtxt(0, context("conv_factor",    conv_factor,
                                  "cycle_op_count", cycle_op_count,
                                  "grid_cmplxty",   grid_cmplxty,
                                  "operat_cmplxty", operat_cmplxty,
                                  "cycle_cmplxty",  cycle_cmplxty));
