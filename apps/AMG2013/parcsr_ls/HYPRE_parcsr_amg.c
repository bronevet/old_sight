...
HYPRE_BoomerAMGSetup( HYPRE_Solver solver,
                   ...
                   HYPRE_ParVector b,
                   HYPRE_ParVector x, context& runCfg/*,
                   ...
                   context& solverCtxt, int& num_precond_calls      )
{
   ...
   return( hypre_BoomerAMGSolve( (void *) solver,
                              ...
                              runCfg,
                              AMGVCycleGraph,
                              lastAnchor, solverCtxt, num_precond_calls ) );
}
...
{
   return( hypre_BoomerAMGSetAggTruncFactor( (void *) solver,
                                           agg_trunc_factor ) );
}
...
HYPRE_BoomerAMGSetAggPMaxElmts( HYPRE_Solver solver,
                            int   agg_P_max_elmts  )
{
   return( hypre_BoomerAMGSetAggPMaxElmts( (void *) solver,
                                           agg_P_max_elmts ) );
}
...
int
HYPRE_BoomerAMGSetPMax1( HYPRE_Solver solver,
                            int   P_max1  )
{
   return( hypre_BoomerAMGSetPMax1( (void *) solver,
                                           P_max1 ) );
}
/*--------------------------------------------------------------------------
...
int
HYPRE_BoomerAMGSetPMax2( HYPRE_Solver solver,
                            int   P_max2  )
{
   return( hypre_BoomerAMGSetPMax2( (void *) solver,
                                           P_max2 ) );
}
/*--------------------------------------------------------------------------
...
int
HYPRE_BoomerAMGSetChebyEigRatio( HYPRE_Solver  solver,
                                 double         ratio )
{
   return( hypre_BoomerAMGSetChebyEigRatio( (void *) solver, ratio ) );
}
...
HYPRE_BoomerAMGSetMaxCoarseSize( HYPRE_Solver  solver,
                                   int thresh )
{
   return( hypre_BoomerAMGSetMaxCoarseSize( (void *) solver, thresh ) );
}
int
HYPRE_BoomerAMGSetSeqThreshold( HYPRE_Solver  solver,
                                   int thresh )
{
   return( hypre_BoomerAMGSetSeqThreshold( (void *) solver, thresh ) );
}
