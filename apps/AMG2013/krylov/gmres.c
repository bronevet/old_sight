...
/* default preconditioner must be set here but can be changed later... */
   //typedef int    (*precond_setup)(void *vdata, void *A, void *b, void *x);
   gmres_functions->precond_setup = (HYPRE_PtrToSolverFcn)PrecondSetup;
   //typedef int    (*precond)(void *vdata, void *A, void *b, void *x);
   gmres_functions->precond       = (HYPRE_PtrToSolverFcn)Precond;
                  ...
                  context& runCfg)
{
   ...
   HYPRE_PtrToSolverFcn precond_setup = (gmres_functions->precond_setup);
                 ...
                 context& runCfg)
{
   ...
   HYPRE_PtrToSolverFcn precond  = (gmres_functions -> precond);
   int 	            *precond_data = (int*)(gmres_data -> precond_data);
  ...
  /* set the relative_error to initially bypass the stopping criterion */
   ...
   /* initialize first term of hessenberg system */
                         ...
                         && iter < max_iter)
	{
		...
		precond((HYPRE_Solver)precond_data, (HYPRE_Matrix)A, (HYPRE_Vector)p[i-1], (HYPRE_Vector)r, runCfg, AMGVCycleGraph, lastAnchor);
	...
	(*(gmres_functions->ClearVector))(r);
	precond((HYPRE_Solver)precond_data, (HYPRE_Matrix)A, (HYPRE_Vector)w, (HYPRE_Vector)r, runCfg, AMGVCycleGraph, lastAnchor);
