...
#elif defined(REAL10)
typedef real10  Real_t ;  // floating point representation
#else
#error
#endif
...
class Domain {
   ...
   Index_t&  numEdgeNodes()       { return m_numEdgeNodes; }
   Index_t&  numEdgeElems()       { return m_numEdgeElems; }
  ...
  private:
   ...
   Index_t m_numElem ;
   Index_t m_numNode ;
   Index_t m_numEdgeNodes ;
   Index_t m_numEdgeElems ;
